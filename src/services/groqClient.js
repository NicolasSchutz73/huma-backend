...
const buildAnalysisReportPrompt = ({ context, actionCatalog, activityCatalog }) => {
  return [
    ...
    "Respecte les volumes maximums: jusqu'à 3 strengths, jusqu'à 5 weaknesses, exactement 4 recommendedActions, exactement 3 teamActivities.",
    "N'invente pas de point fort ou de point faible de remplissage pour atteindre un quota. S'il n'existe que 2 vrais strengths, renvoie 2 strengths.",
